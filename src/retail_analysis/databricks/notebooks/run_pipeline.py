...
def run_pipeline(spark,config_path: str = "src/retail_analysis/configs/etl.yml") -> Dict[str, Any]:
    ...
    try:
        ...
        from retail_analysis.databricks.notebooks.ingestion import run_bronze
        from retail_analysis.databricks.notebooks.enrich_customers_products import run_silver
        from retail_analysis.databricks.notebooks.master_orders import run_master_orders
        from retail_analysis.databricks.notebooks.aggregate import run_profit_aggregate
        from retail_analysis.databricks.notebooks.kpis import run_reporting
